...
# 3. Remove content-r
alt_marker = '<!-- \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 RUTA ALTERNATIVA \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->'
s = c.find(alt_marker)
e = c.find('</div><!-- /content-r -->', s) + len('</div><!-- /content-r -->')
c = c[:s] + c[e:]
print('3. ' + str(len(c)))
...
# 6. Milan collapsed
mil_marker = '<!-- \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 MIL\u00c1N'
idx = c.find(mil_marker)
open_tag = '<details class="city-card" open>'
oi = c.find(open_tag, idx)
...
# 8. Move private to bottom
pw_s = c.find('<div class="password-gate" id="passwordGate">')
pw_e = c.find('</section>', c.find('<!-- Links -->')) + len('</section>')
pw_sec = c[pw_s:pw_e]
c = c[:pw_s] + c[pw_e:]
...
for t in ['RUTA ALTERNATIVA', 'RUTA ORIGINAL', 'route-tabs', 'route-wrap', 'content-f', 'content-r', 'Friburgo', 'Ginebra \u00b7 Neuch']:
    print('  ' + t + ': ' + str(t in c))
pw_pos = c.find('passwordGate')
print('  PW at bottom: ' + str(pw_pos > len(c)*0.6))
print('  Budget at bottom: ' + str(c.find('PRESUPUESTO') > len(c)*0.6))
print('  Milan open: ' + str('<details class="city-card" open>' in c))
print('  Hero below: ' + str(c.find('hero-cover') > c.find('13')))